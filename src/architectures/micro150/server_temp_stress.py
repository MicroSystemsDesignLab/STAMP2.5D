...
base_dir   = r"<path_to_your_workspace>\AI_Temperature\Micro150_updated"
...
def therm_mech(layer_file, power):
    ...
    process_ansys_iteration(
        xls_file_path=os.path.join(xls_dir, f"{arch}_34401_{index}_temp.xls"),
        chiplets=chiplets,
...
def geometry_from_layers(file_contents):
    ...
    path_ = r"<path_to_your_workspace>\AI_Temperature\Micro150_updated"
