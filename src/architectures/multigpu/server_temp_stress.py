...
base_dir   = r"<path_to_your_workspace>\AI_Temperature"
xls_dir = os.path.join(base_dir, "ansys_export")
...
def therm_mech(layer_file, power):
    ...
    power_list= [105,295,295,20,20,20]
...
def geometry_from_layers(file_contents):
    ...
    path_ = r"<path_to_your_workspace>\AI_Temperature"
